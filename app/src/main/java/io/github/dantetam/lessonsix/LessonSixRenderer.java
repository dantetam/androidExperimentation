...
{	
	...
	private final LessonSixActivity mActivityContext;
	 ...
	 */
	public LessonSixRenderer(final LessonSixActivity activityContext)
	{	
	...
	public void onDrawFrame(GL10 glUnused) 
	{
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            @Override
            public void run() {
                mActivityContext.update((TextView) mActivityContext.findViewById(R.id.image_textview_test0), frames / 10);
                mActivityContext.update((TextView) mActivityContext.findViewById(R.id.image_textview_test1), frames / 10 + 1);
                mActivityContext.update((TextView) mActivityContext.findViewById(R.id.image_textview_test2), frames / 10 + 2);
                mActivityContext.update((TextView) mActivityContext.findViewById(R.id.image_textview_test3), frames / 10 + 3);
                mActivityContext.update((TextView) mActivityContext.findViewById(R.id.image_textview_test4), frames / 10 + 4);
